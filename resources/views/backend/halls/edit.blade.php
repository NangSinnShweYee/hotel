...
<div class="card uper">
    ...
    <div class="card-body">
        ...
        @endif
        <div class="container">
            <form method="post" action="{{ route('halls.update',$halls->id) }}" enctype="multipart/form-data">

                <input type="hidden" name="_method" value="PUT">
                <div class="form-group">
                          <label for="name">Name:</label>
                    <input type="text" class="form-control" name="name" value="{{$halls->name}}" />
                </div>
                <div class="form-group">
                    @csrf
                ...
                <div class="tab-pane fade" id="contact" role="tabpanel" aria-labelledby="contact-tab">
                  ...
                  <div class="form-group">                        
                        ...
                        <input type="number" class="form-control" name="capacity" value="{{$halls->capacity}}" />
                </div>
                  <div class="form-group">
                          <label for="name">Location:</label>
                    <input type="text" class="form-control" name="location" value="{{$halls->location}}" />
                </div>
                <div class="form-group">                        
                               <label for="user_password" class="col-md-4 control-label">description</label>
                    <textarea name="description" cols="30" rows="10"
                        class="form-control {{ $errors->has('description') ? ' is-invalid' : '' }}">{{$halls->description}}</textarea>
