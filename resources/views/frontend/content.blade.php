		...
		<div id="qbootstrap-services" class="qbootstrap-services bg-primary-color">
			<div class="container">
				<div class="row">
					<div class="col-md-4 animate-box">
						<div class="services">
							...
							<div class="desc">
								<h3><a href="#">The most reliable hotel</a></h3>
					...
					<div class="col-md-4 animate-box">
						<div class="services">
							...
							<div class="desc">
								<h3><a href="#">User friendly search system</a></h3>
								<p>Dignissimos asperiores vitae velit veniam totam fuga molestias accusamus alias autem provident. Odit ab aliquam dolor eius.</p>
							</div>
						</div>
					</div>
					<div class="col-md-4 animate-box">
						<div class="services">
							...
							<div class="desc">
								<h3><a href="#">Payment Facilities For You</a></h3>
								<p>Dignissimos asperiores vitae velit veniam totam fuga molestias accusamus alias autem provident. Odit ab aliquam dolor eius.</p>
							</div>
						</div>
					</div>
		...
		<div id="qbootstrap-dining-bar" class="diningbar-flex">
			<div class="half animate-box">
				<h2 class="title-head">Dining &amp; Bar</h2>
		...
		<div id="qbootstrap-blog" class="blog-flex">
			<div class="featured-blog" style="background-image: url(images/blog-2.jpg);">
				<div class="desc-t">
					<div class="desc-tc">
						<span class="featured-head">Featured Posts</span>
						<h3><a href="#">9 Ways to Become a Successful Travel Blogger</a></h3>
						<span><a href="#" class="read-button">Learn More <i class="icon-arrow-right3"></i></a></span>
					</div>
				</div>
			</div>
			<div class="blog-entry">
				<div class="row animate-box">
					<div class="col-md-12">
						<h2 class="title-head">Latest Blog</h2>
					</div>
				</div>
				<div class="row">
					<div class="col-md-12 animate-box">
			...
			<div class="container">
				...
				<div class="col-md-4 animate-box">
					<div class="testimony text-center">
						...
						<span class="user">Mark Tylor</span>
						<blockquote>
							<p><i class="icon-quotes-left"></i> Dignissimos asperiores vitae velit veniam totam fuga molestias accusamus alias autem provident. Odit ab aliquam dolor eius.</p>
						</blockquote>
					</div>
				</div>
				<div class="col-md-4 animate-box">
					<div class="testimony text-center">
						...
						<span class="user">Megan Fox</span>
						<blockquote>
							<p><i class="icon-quotes-left"></i> Dignissimos asperiores vitae velit veniam totam fuga molestias accusamus alias autem provident. Odit ab aliquam dolor eius.</p>
						</blockquote>
					</div>
				...
				<div class="col-md-4 animate-box">
					<div class="testimony text-center">
						...
						<span class="user">Divine Dee</span>
						<blockquote>
							<p><i class="icon-quotes-left"></i> Dignissimos asperiores vitae velit veniam totam fuga molestias accusamus alias autem provident. Odit ab aliquam dolor eius.</p>
						</blockquote>
					</div>
		...
		<div id="qbootstrap-subscribe" style="background-image: url(images/img_bg_2.jpg);">
			<div class="overlay"></div>
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3 text-center qbootstrap-heading animate-box">
						<h2>Sign Up for a Newsletter</h2>
						<p>Get 100% Free Templates via <a href="https://qbootstrap.com/">QBootstrap.com</a>. It is Free so what are you waiting for? Grab your template!. Download and Share</p>
